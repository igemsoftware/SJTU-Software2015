...
load data local infile 'ncombine_v1.txt' into table combine fields terminated by '|';
load data local infile 'nbrick_v1.txt' into table brick fields terminated by '|';
